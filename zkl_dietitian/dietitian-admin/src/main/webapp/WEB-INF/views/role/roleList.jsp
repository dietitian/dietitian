...
<script type="text/javascript">
	function deleteRole(id,name) {
		  if(confirm("您确删除角色 : '"+name+"' 这条记录吗？")){
			$.get("${pageContext.request.contextPath}/role/delete/" + id, function(
					data) {
...
<body>
   <div id="legend">
	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span12">
			<form class="form-inline" role="form" action="${pageContext.request.contextPath}/role/list" method="post">
				 <div class="form-group">
				    名称:
				  </div>
				  <div class="form-group">
				    <label class="sr-only" >名称：</label>
				    <input type="text" class="form-control" name="name" value="${sessionScope.roleSearch.name}">
				  </div>
				...
				<display:table name="roleList.list" id="role"
				requestURI="${pageContext.request.contextPath}/role/list"
				pagesize="${pageSize}" partialList="true"
				size="${roleList.fullListSize}" class="table">
				...
				<display:column title="操作">
					<!-- <a data-toggle="modal" data-target="#addModal"  ><i
						...
						<a href="${pageContext.request.contextPath}/role/update/${role.id}"><i
				class="icon-edit icon-large"></i></a>
					<!-- <button  data-toggle="modal" data-target="#myModal">
				   			<i class="icon-edit icon-large"></i>
					</button> -->	
					&nbsp;&nbsp;&nbsp;<a href="javascript:deleteRole('${role.id}','${role.name}')"><i
						class="icon-trash icon-large"></i></a>
					&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/role/managerFunction/${role.id}">授权</a>
				</display:column>
			</display:table>
			<br /> 
	  ...
	  <div class="modal-dialog">
	    <div class="modal-content">
	      ...
	      <div class="modal-body" style=" height:400px;">
	          <form class="form-horizontal" id="RoleFrom" action="${pageContext.request.contextPath}/role/add" method="post">
				    <fieldset>
