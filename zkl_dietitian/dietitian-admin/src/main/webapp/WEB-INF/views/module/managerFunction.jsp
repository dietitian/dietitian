...
function addFunctions(id){
   ...
   for(var i=0;i<r.length;i++){
	    ...
	    $.post("${pageContext.request.contextPath}/module/addFunctions",{ids:ids,id:id},function(data){
...
function deleteFunctions(id){
   ...
   if(confirm("您确认删除吗？")){
	   $.post("${pageContext.request.contextPath}/module/deleteFunctions",{ids:ids,id:id},function(data){
...
<div class="container-fluid">
    <div id="legend">
          <legend><font color="blue">安全管理&gt;&gt;模块管理&gt;&gt;授权</font></legend>
</div>
 ...
 <button class="button button-rounded" type="submit">
					...
					<div class="container-fluid">
						<div class="row-fluid">
							<div class="span12">
								<display:table name="noFunctions" id="function" pagesize="5" 
							...
							<div class="span4">
								<a href="javascript:addFunctions('${module.id}')" >
 ...
 <button class="button button-rounded" type="submit">
				     <i class="icon-search"></i> 查找</button>
						...
						<div class="container-fluid">
							<div class="row-fluid">
								<div class="span12">
									<display:table name="module.functions" id="function" pagesize="5" 
									 requestURI="${pageContext.request.contextPath}/module/managerFunction/${module.id}"
									>
								...
								<div class="span4">
									<a href="javascript:deleteFunctions('${module.id}')" >
