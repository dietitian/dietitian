...
<script type="text/javascript">
	function deleteFunction(id,name) {
		  if(confirm("您确删除名称为 : '"+name+"' 这条记录吗？")){
			$.get("${pageContext.request.contextPath}/module/delete/" + id, function(
					data) {
...
<div id="legend">
          <legend><font color="blue">安全管理&gt;&gt;模块管理</font></legend>
</div>
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span12">
			<form class="form-inline" role="form" action="${pageContext.request.contextPath}/module/list" method="post">
				 <div class="form-group">
				    名称:
				  </div>
				  <div class="form-group">
				    <label class="sr-only" >名称：</label>
				    <input type="text" class="form-control" name="name" value="${sessionScope.moduleSearch.name}">
				  </div>
				  <!--  <div class="form-group">
				    路径：
				  </div>
				...
				<display:table name="moduleList.list" id="module"
				requestURI="${pageContext.request.contextPath}/module/list"
				pagesize="${pageSize}" partialList="true"
				size="${moduleList.fullListSize}" class="table">
				...
				<display:column title="操作">
					<!-- <a data-toggle="modal" data-target="#addModal"  ><i
						...
						<a href="${pageContext.request.contextPath}/module/update/${module.id}"><i
				class="icon-edit icon-large"></i></a>
					&nbsp;&nbsp;&nbsp;<a href="javascript:deleteFunction('${module.id}','${module.name}')"><i
						class="icon-trash icon-large"></i></a>
					&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/module/managerFunction/${module.id}">授权</a>
				</display:column>
			</display:table>
			<br />
	  ...
	  <div class="modal-dialog">
	    <div class="modal-content">
	      <div class="modal-header">
	        ...
	        <h4 class="modal-title" id="myModalLabel">新增功能模块</h4>
	      </div>
	      <div class="modal-body" style=" height:400px;">
	          <form class="form-horizontal" id="PrivilegeFrom" action="${pageContext.request.contextPath}/module/add" method="post">
				    <fieldset>
